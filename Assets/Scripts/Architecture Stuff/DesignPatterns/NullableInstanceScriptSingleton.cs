...
/// <summary>
/// An abstract class used as a template for all monobehaviour classes
...
public abstract class NullableInstanceScriptSingleton<T> : MonoBehaviour where T : MonoBehaviour
{
    /// <summary>
